...
CREATE TABLE "badges_to_products" (
	"id" integer PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "badges_to_products_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"badge_id" integer,
	"product_id" integer
);
--> statement-breakpoint
...
CREATE TABLE "categories" (
	...
	"parent_image" text,
	"parent_banner" text,
	"parent_meta_title" text,
	"parent_meta_description" text,
	"image" text,
	"color" text,
	"icon" text,
	"parent_id" integer,
...
--> statement-breakpoint
ALTER TABLE "badges_to_products" ADD CONSTRAINT "badges_to_products_badge_id_badges_id_fk" FOREIGN KEY ("badge_id") REFERENCES "public"."badges"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "badges_to_products" ADD CONSTRAINT "badges_to_products_product_id_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "cart_items" ADD CONSTRAINT "cart_items_product_id_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "color_image" ADD CONSTRAINT "color_image_product_id_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
